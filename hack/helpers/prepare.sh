...
sed -i.bak "s/provider-cmdb/provider-${ProviderNameLower}/g" go.mod
...
git mv "cluster/images/provider-cmdb" "cluster/images/provider-${ProviderNameLower}"
git mv "cluster/images/provider-cmdb-controller" "cluster/images/provider-${ProviderNameLower}-controller"
